...
Each column below represents a card as it actually looks — with realistic content, actual CSS values annotated on each element, and line references.

```
  TYPE 1: SCREENSHOT CARD               TYPE 2: PEDIR PLATAFORMA              TYPE 3: EMPTY CARD
  (e.g. Gestão de Despesas)              (Request new platform)                (Icon + text, no dashboard)

╔══════════════════════════════╗    ╔══════════════════════════════╗    ╔══════════════════════════════╗
║ .platform-card               ║    ║ .platform-card               ║    ║ .platform-card               ║
║ bg: rgba(255,255,255,0.015)  ║    ║ bg: rgba(255,255,255,0.015)  ║    ║ bg: rgba(255,255,255,0.015)  ║
║ blur(10px) sat(180%)         ║    ║ blur(10px) sat(180%)         ║    ║ blur(10px) sat(180%)         ║
║ border: 1px solid            ║    ║ border: 1px solid            ║    ║ border: 1px solid            ║
...
║ │ bg: #111111 (opaque)  │    ║    ║ │ bg: #111111 (opaque)  │    ║    ║ │ bg: #111111 (opaque)  │    ║
║ │ aspect-ratio: 4/3     │    ║    ║ │ aspect-ratio: 4/3     │    ║    ║ │ aspect-ratio: 4/3     │    ║
║ │                       │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ ┌─────────────────┐  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ │ .mini-dash-header│  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ │ bg:rgba(w,0.015) │  │    ║    ║ │                       │    ║    ║ │                       │    ║
...
║ │ ┌────┐┌────┐┌────┐   │    ║    ║ │       font: 2.5rem   │    ║    ║ │         📎            │    ║
║ │ │1200€││ 3  ││Pend│   │    ║    ║ │                      │    ║    ║ │                       │    ║
║ │ │green││green││red │   │    ║    ║ │         ➕           │    ║    ║ │    .preview-name      │    ║
║ │ │Total││Reg. ││Est.│   │    ║    ║ │                      │    ║    ║ │    font: 0.8rem       │    ║
║ │ └────┘└────┘└────┘   │    ║    ║ │                      │    ║    ║ │    color: #666         │    ║
║ │ .mini-stat ×3         │    ║    ║ │                      │    ║    ║ │    "Platform Name"    │    ║
║ │ bg:rgba(w,0.015)      │    ║    ║ │                      │    ║    ║ │                       │    ║
║ │ blur(6px) sat(160%)   │    ║    ║ │                      │    ║    ║ │                       │    ║
║ │                       │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ ┌─────────────────┐  │    ║    ║ │                       │    ║    ║ │                       │    ║
...
║ │ padding: 14px 16px    │    ║    ║ │ padding: 14px 16px    │    ║    ║ │ padding: 14px 16px    │    ║
║ │ bg: transparent       │    ║    ║ │ bg: transparent       │    ║    ║ │ bg: transparent       │    ║
║ │                       │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ ┌─────────────────┐  │    ║    ║ │ .platform-name        │    ║    ║ │ ┌─────────────────┐  │    ║
║ │ │.platform-info-row│  │    ║    ║ │ "➕ Pedir Plataforma" │    ║    ║ │ │.platform-info-row│  │    ║
║ │ │                  │  │    ║    ║ │ font: 0.85rem #f6f6f6 │    ║    ║ │ │                  │  │    ║
║ │ │ .platform-name   │  │    ║    ║ │                       │    ║    ║ │ │ .platform-name   │  │    ║
║ │ │ "💰 Gestão de    │  │    ║    ║ │ .platform-desc        │    ║    ║ │ │ "📎 Platform"    │  │    ║
║ │ │  Despesas"       │  │    ║    ║ │ "Solicitar nova       │    ║    ║ │ │                  │  │    ║
║ │ │ font: 0.85rem    │  │    ║    ║ │  plataforma"          │    ║    ║ │ │ .platform-desc   │  │    ║
║ │ │ color: #f6f6f6   │  │    ║    ║ │ font: 0.7rem #a0a0a0  │    ║    ║ │ │ "Description"    │  │    ║
║ │ │                  │  │    ║    ║ │                       │    ║    ║ │ │                  │  │    ║
║ │ │ .platform-desc   │  │    ║    ║ │ (NO .info-row)        │    ║    ║ │ │ .access-toggle ▾ │  │    ║
║ │ │ "Gerir e acompa- │  │    ║    ║ │ (NO access controls)  │    ║    ║ │ └─────────────────┘  │    ║
║ │ │  nhar despesas"  │  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ │ font: 0.7rem     │  │    ║    ║ │                       │    ║    ║ │ .access-panel (hidden)│    ║
║ │ │ color: #a0a0a0   │  │    ║    ║ │                       │    ║    ║ │ (admin only)          │    ║
║ │ │                  │  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ │ .access-toggle ▾ │  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │ └─────────────────┘  │    ║    ║ │                       │    ║    ║ │                       │    ║
║ │                       │    ║    ║ │                       │    ║    ║ │                       │    ║
...
╚══════════════════════════════╝    ╚══════════════════════════════╝    ╚══════════════════════════════╝
  ...
  ::before sits on top of everything (z-index: 1)
  Shine: linear-gradient(90deg, transparent, rgba(255,255,255,0.08), transparent)
  Resting: left: -100%  →  On hover: left: 100% (transition: 0.5s)
  ⚠️ Only visible on screenshot cards — too faint on flat #111 of empty/pedir
```
