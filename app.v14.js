...
const allProjects = [
  {
    value: 'ÁLBUM GERAL - "BAIRRO DAS FLORES"',
    label: '🎵 ÁLBUM GERAL - "BAIRRO DAS FLORES"',
  },
  {
    value: 'TU ÉS ft. "Os Quatro e Meia"',
    label: '🎵 TU ÉS ft. "Os Quatro e Meia"',
  },
  ...
  {
    value: "PRIMAVERA Ft. António Zambujo",
    label: "🎵 PRIMAVERA Ft. António Zambujo",
  },
...
function sanitizeExpenses() {
  ...
  expenses = expenses.filter((e) => {
    ...
    if (typeof e.amount !== "number" || isNaN(e.amount)) return false;
    // Normalize investor: anything that isn't "maktub" is treated as
    // "outros" (third-party / artist paid). Auto-heals records imported with
    // raw artist names in the investor column (the original Madalena bug
    // where "Terceiros" appeared in random places in the Excel).
  ...
  return [
    {
      ...
      project: 'ÁLBUM GERAL - "BAIRRO DAS FLORES"',
      type: "promocao",
    ...
    },
    {
      ...
      project: 'ÁLBUM GERAL - "BAIRRO DAS FLORES"',
      type: "equipamento",
      entity: "Roll Up Promo Álbum (usado no Pax Júlia)",
      investor: "maktub",
      amount: 25,
      notes: "",
    },
    {
      ...
      type: "equipamento",
      entity:
        "Roll Up Promo Álbum (usado Festa Lançamento - Álbum disponível + transporte)",
      investor: "maktub",
      amount: 40,
      notes: "",
    },
    ...
    },
    {
      ...
      investor: "bandidos",
      amount: 0,
      notes: "OFERECIDO POR VALE DO SOBROSO - 1250",
    },
    {
      id: "bandidos-012",
      date: "2025-01-01",
      artist: "Bandidos do Cante",
      project: 'TU ÉS ft. "Os Quatro e Meia"',
      type: "alimentacao",
    ...
    },
    {
      ...
      date: "2025-10-01",
      artist: "Bandidos do Cante",
      project: "PRIMAVERA Ft. António Zambujo",
      type: "producao",
    ...
    },
    {
      ...
      date: "2024-04-01",
      artist: "Bandidos do Cante",
      project: "VODAFONE PLAY",
      type: "equipamento",
      entity: "Vodafone Play - Styling",
      investor: "maktub",
      amount: 91,
      notes: "TOTAL 591. PLAY deram-nos 500€, logo só gastamos 91",
    },
    {
      id: "bandidos-075",
      date: "2024-04-01",
    ...
    },
    {
      ...
      project: "DESIGNER",
      type: "promocao",
      entity: 'Lettering "Um Dia Hei-de Voltar"',
      investor: "maktub",
      amount: 0,
      notes: "OFERTA MAKTUB",
    },
    ...
    },
    {
      ...
      amount: 2860,
      notes:
        "O MERCH JÁ ESTÁ A SER VENDIDO. URGENTE PERCEBER PARA ONDE ENVIAR O DINHEIRO E UMA ESTRUTURA PARA VENDAS FUTURAS . https://docs.google.com/spreadsheets/d/15uxJ1Dc4TRGIkDA-uZWByj0UWI5HIFxa3bzIphjcgCk/edit?usp=sharing",
    },
    {
      id: "bandidos-100",
      date: "2025-12-01",
    ...
    },
    {
      ...
      project: "ROSA",
      type: "producao",
      entity: "Pintura cenário - Leonor NG",
      investor: "maktub",
      amount: 175,
      notes: "",
    },
...
function getInvestorKey(name) {
  ...
  if (!n) return null;
  if (n === "maktub" || n === "maktub art group" || n === "nos" || n === "nós")
    return "maktub";
  // Any other recognised non-Maktub label (artist name, "artista", "terceiros",
  // "outros", "bandidos", etc.) means "the artist / a third party paid".
  // Normalise everything to "outros" so the Apps Script PROVEITOS/CUSTOS split
  // is unambiguous (anything !== "maktub" lands in PROVEITOS).
  return "outros";
}
